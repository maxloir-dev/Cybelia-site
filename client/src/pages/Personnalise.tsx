		...
		<div className="perso-page">
			...
			<section className="perso-hero">
				...
				<h1 className="perso-hero-titre">
					DONNEZ VIE<br />À VOS SOUVENIRS
				</h1>
				<p className="perso-hero-desc">
					Une illustration unique, créée à partir de vos souvenirs ou de vos projets.
				</p>
			...
			<section className="perso-texte-long">
				<div className="perso-texte-long-content">
					<p>
						Une maison de famille, un lieu de voyage ou un village qui vous est cher : chaque
						photo peut devenir une illustration personnalisée, créée avec soin pour raconter une
						histoire unique et préserver vos plus beaux souvenirs.
					</p>
					<p>
						Ces créations s'adressent également aux professionnels : collectivités, mairies,
						architectes, agences immobilières, commerces, hébergements touristiques ou
						entreprises souhaitant mettre en valeur leur patrimoine, leur activité ou l'histoire d'un
						lieu à travers une création authentique et sur mesure.
					</p>
					<p>
						Illustration originale réalisée à la main ou projet graphique (cartes de visite, supports
						de communication, visuels personnalisés…), chaque réalisation est pensée selon
						vos envies, vos besoins et l'identité de votre projet.
					</p>
					<p>
						Que ce soit pour décorer votre intérieur, offrir un cadeau chargé d'émotion ou
						valoriser un lieu professionnel, je serais ravie de donner vie à vos images, vos
						souvenirs et vos projets.
					</p>
					<p>
						Découvrez ci-dessous les différentes étapes de création, de l'envoi de votre photo
						jusqu'à la réalisation finale de votre projet.
					</p>
				</div>
			</section>
				...
				<div className="perso-etapes-detail-list">
					<div className="perso-etape-detail">
						...
						<div className="perso-etape-detail-content">
							...
							<p>
								Pour démarrer votre projet, contactez-moi par e-mail en me partageant votre idée,
								vos photos et les informations essentielles. Ensemble, donnons vie à une création
								unique qui vous ressemble.
							</p>
						</div>
					</div>
					<div className="perso-etape-detail">
						...
						<div className="perso-etape-detail-content">
							...
							<p>
								Après réception de votre e-mail, je prends le temps d'étudier votre projet afin de
								comprendre vos envies et les spécificités de votre demande. Je vous transmets
								ensuite un devis personnalisé ainsi qu'une estimation du délai de réalisation avant le
					...
					<div className="perso-etape-detail">
						...
						<div className="perso-etape-detail-content">
							...
							<p>
								Si le devis vous convient, il vous suffit de le signer et de me le retourner. Dès
								réception, votre projet est officiellement lancé et je peux commencer à donner vie à
					...
					<div className="perso-etape-detail">
						...
						<div className="perso-etape-detail-content">
							...
							<p>
								Après la réalisation de votre projet, votre illustration est imprimée avec soin puis
								préparée pour l'expédition. Quelques temps plus tard, votre création rejoint votre
								intérieur ou celui de la personne à qui vous souhaitez l'offrir.
							</p>
						</div>
					</div>
				</div>
