		...
		return (
			<main className="home-sections">
				...
				<div className="section">
					<div className="nouveautes-header">
						...
						<div className="nouveautes-text">
							<p>
								...
								villes, lieux emblématiques et architectures du monde entier. Chaque création
								réalisée à la main vient enrichir la collection pour faire voyager votre intérieur au fil
								des découvertes.
							</p>
						</div>
					</div>
					...
					<div className="nouveautes-btn">
						<p className="nouveautes-btn-text">
							...
							authenticité, inspirées de lieux emblématiques et conçues pour apporter caractère et
							évasion à votre décoration.
						</p>
				...
				<div className="home-pourqui-section">
					...
					<h2 className="perso-section-titre">Nos créations s'adressent à vous</h2>
				...
				<div className="home-perso-section">
					<div className="home-perso-content">
						...
						<h2 className="home-perso-titre">Une création rien que pour vous</h2>
						<p className="home-perso-texte">
							Maison de famille, lieu de voyage ou souvenir précieux : chaque photo peut
							devenir une affiche personnalisée unique et pleine d'émotion.
						</p>
				...
				<div className="home-apropos-section">
					<div className="home-apropos-inner">
						<div className="home-apropos-image-wrapper">
							<img src={aproposImg} alt="Cybélia Charrier, illustratrice" className="home-apropos-image" />
						</div>
						<div className="home-apropos-content">
							...
							<p className="home-apropos-texte">
								Née de la rencontre entre l'art et l'architecture, Cybele Architecture mêle création
								artistique, valorisation du patrimoine et architecture d'intérieur. Guidée par une
								sensibilité profonde pour les lieux et leur histoire, chaque projet devient une façon
								de révéler ce qui rend un espace unique.
							</p>
							<p className="home-apropos-texte">
								À travers des illustrations à l'aquarelle, je mets en lumière les architectures et
								paysages qui façonnent nos territoires — parce que chaque création raconte une
								histoire et célèbre le lien entre patrimoine, art et habitat.
							</p>
							<p className="home-apropos-citation">
								« Le nom Cybele trouve son origine dans Cybèle, déesse de la nature et protectrice
								des lieux dans la mythologie grecque — un symbole qui reflète ma volonté de révéler
								la beauté et l'identité des espaces à travers chacun de mes projets. »
							</p>
